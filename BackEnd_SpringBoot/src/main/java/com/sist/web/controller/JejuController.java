...
public class JejuController {
	...
	@GetMapping("jeju/location_top9_react")
	public List<JejuLocationEntity> location_top9(){
		List<JejuLocationEntity> list = lDao.jejuLocationTop9();
		return list;
	}
	@GetMapping("jeju/food_top9_react")
	public List<JejuFoodEntity> food_top9(){
